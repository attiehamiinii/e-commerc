...
const AddressFrom = ({checkoutToken,next}) => {
  ...
  const fetchSubdivisions = async (countryCode) => {
    const { subdivisions } = await commerce.services.localeListSubdivisions(countryCode);  setShippingSubdivisions(subdivisions)
  ...
  return (
    <>
    <Typography variant='h6' gutterBottom>Shippind Address</Typography>
    ...
    <Select value={shippingSubdivision} fullWidth onChange={(e) => setShippingSubdivision(e.target.value)}>      {subdivisions.map((subdivision)=>(
